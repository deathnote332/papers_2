    ...
    */
    ...
    'events' => array(
        ...
        'beforeRenderTheme' => function($theme)
        {
            ...
            $theme->asset()->usePath()->add('jquery.dataTables.min.js', 'js/jquery.dataTables.min.js');
            $theme->asset()->usePath()->add('dataTables.bootstrap.min.js', 'js/dataTables.bootstrap.min.js');
            $theme->asset()->usePath()->add('dataTables.bootstrap.min.css', 'css/dataTables.bootstrap.min.css');
        },
